...
$json = file_get_contents('http://www.lucymodas.com/api/productos/' . $id_categoria);
		...
		<?php foreach($productos as $i => $p){ ?>
			...
			<div class="col s6" style="padding-<?=$border;?>: 0px;">
				<div class="card producto-lista-pdf">
					...
					<img src="//lucymodas.com/catalogo/<?=$p->id_categoria;?>/<?=$p->codigo;?>_1_238.jpg">
					<div class="marca-agua"><?=$p->codigo;?></div>
					<div class="mini">
						<img src="//lucymodas.com/catalogo/<?=$p->id_categoria;?>/<?=$p->codigo;?>_2_67.jpg">
					</div>
					<?php if($p->precio <= 800 && $p->id_categoria == 1){ ?>
						<div class="estrella">
					...
					<div class="card-content">
						...
						<div class="tallas">
							<?php
							if($p->talla_unica*1){
								echo '<div class="chip">TALLA UNICA</div>';
							}else{
