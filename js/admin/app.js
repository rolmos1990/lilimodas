(function(){
    ...
    app.config(function($routeProvider){
        $routeProvider.
            ...
            when('/rotativo-principal',{templateUrl:'html/admin/rotativo.html',controller:'rotativoController',controllerAs:'rotativo'}).
            when('/rotativo-secundario',{templateUrl:'html/admin/rotativo.html',controller:'rotativoController',controllerAs:'rotativo'}).
            when('/novedades',{templateUrl:'html/admin/novedades.html',controller:'novedadesController',controllerAs:'novedades'}).
            when('/novedades/:novedad',{templateUrl:'html/admin/novedad.html',controller:'novedadController',controllerAs:'novedad'}).
            when('/comentarios',{templateUrl:'html/admin/comentarios.html',controller:'comentariosController',controllerAs:'comentarios'}).
            when('/movil',{templateUrl:'html/admin/movil.html',controller:'movilController',controllerAs:'movil'}).
...
//    }]);
    ...
    app.controller('categoriasController', ['$http','$timeout','helpers','ngDialog','Upload','$location', function($http,$timeout,helpers,ngDialog,Upload,$location){
        ...
        this.nueva = function(){
            ngDialog.openConfirm({
                template: 'html/admin/dialog/nueva-categoria.html',
        ...
        this.cambiarNombre = function(categoria){
            ngDialog.openConfirm({
                ...
                controllerAs: 'dialog',
                template: 'html/admin/dialog/cambiar-nombre-categoria.html',
                className: 'ngdialog-theme-default'
            }).then(function(nombre){
                categorias.cargando = true;
        ...
        this.eliminar = function(categoria){
            ngDialog.openConfirm({
                ...
                controllerAs: 'dialog',
                template: 'html/admin/dialog/eliminar-categoria.html',
                className: 'ngdialog-theme-default'
            }).then(function(){
                categorias.cargando = true;
    ...
    app.controller('categoriaController', ['$http','$routeParams','helpers','ngDialog','$location', function($http,$routeParams,helpers,ngDialog,$location){
        ...
        this.incrementarDecrementar = function(){
            ...
            ngDialog.openConfirm({
                controller: function(){
                    this.incremento = parseInt(categoria.data.incremento)
                },
                controllerAs: 'dialog',
                template: 'html/admin/dialog/incremento.html',
                className: 'ngdialog-theme-default'
            }).then(function(incremento){
                categoria.cargando = true;
                $http.post('admin/incrementogroups',helpers.httpParam({id: categoria.data.id,incremento: incremento}),{ headers: {'Content-Type': 'application/x-www-form-urlencoded;charset=utf-8'} }).success(function(data){
                    categoria.cargar();
                }).error(function(data,status){
                    categoria.cargando = false;
                    if(status===401){
        ...
        this.vaciar = function(){
            ngDialog.openConfirm({
                template: 'html/admin/dialog/vaciar-categoria.html',
                className: 'ngdialog-theme-default'
            }).then(function(){
                categoria.cargando = true;
        ...
        this.descuentos = function(){
            ngDialog.openConfirm({
                ...
                controllerAs: 'dialog',
                template: 'html/admin/dialog/descuentos.html',
                className: 'ngdialog-theme-default'
        ...
        this.eliminar = function(producto){
            ngDialog.openConfirm({
                ...
                controllerAs: 'dialog',
                template: 'html/admin/dialog/eliminar-producto.html',
                className: 'ngdialog-theme-default'
            }).then(function(){
                categoria.cargando = true;
        ...
        this.cargar = function(){
            ...
            if(codigo !== 'nuevo'){
                ...
                $http.get('admin/producto/' + codigo).success(function(data){
                    ...
                    producto.data.masVendido = parseInt(producto.data.masVendido || 0);
    ...
    app.controller('rotativoController', ['$http','$location','$timeout','Upload','helpers','ngDialog',function($http,$location,$timeout,Upload,helpers,ngDialog){
        ...
        this.nombreCategoria = function(categoria){
            return categoria.nombre.toLowerCase().replace(/[\W_]+/g,"-");
        };
        this.cargar = function(){
        ...
        this.eliminar = function(imagen){
            ngDialog.openConfirm({
                ...
                controllerAs: 'dialog',
                template: 'html/admin/dialog/eliminar-imagen.html',
                className: 'ngdialog-theme-default'
            }).then(function(){
                rotativo.cargando = true;
    ...
    app.controller('comentariosController', ['$http','ngDialog','helpers','$location', function($http,ngDialog,helpers,$location){
        ...
        this.eliminar = function(comentario){
            ngDialog.openConfirm({
                ...
                controllerAs: 'dialog',
                template: 'html/admin/dialog/eliminar-comentario.html',
                className: 'ngdialog-theme-default'
            }).then(function(){
                comentarios.cargando = true;
    ...
    app.controller('novedadesController', ['$http','ngDialog','helpers','$location', function($http,ngDialog,helpers,$location){
        ...
        this.eliminar = function(novedad){
            ngDialog.openConfirm({
                ...
                controllerAs: 'dialog',
                template: 'html/admin/dialog/eliminar-novedad.html',
                className: 'ngdialog-theme-default'
            }).then(function(){
                novedades.cargando = true;
